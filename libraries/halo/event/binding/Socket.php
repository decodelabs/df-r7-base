...
class Socket extends Base implements halo\event\ISocketBinding
{
    ...
    public function __construct(halo\event\IDispatcher $dispatcher, $isPersistent, link\Socket $socket, $ioMode, $callback, $timeoutDuration=null, $timeoutCallback=null)
    {
        $this->socket = $socket;
