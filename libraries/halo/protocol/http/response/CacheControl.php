...
class CacheControl implements halo\protocol\http\IResponseCacheControl {
    ...
    public function shouldRevalidate($flag=null) {
        if($flag !== null) {
            $this->_mustRevalidate = (bool)$flag;
            return $this;
        }
    ...
    public function shouldRevalidateProxy($flag=null) {
        if($flag !== null) {
            $this->_proxyRevalidate = (bool)$flag;
            return $this;
        }
