...
class Reader implements IReader {
    ...
    public static function openFile($path) {
        ...
        return new self((new core\io\channel\File($path, core\io\IMode::READ_ONLY))->setContentType('text/csv'));
    }

    public static function openString($string) {
        return new self(new core\io\channel\Memory($string, 'text/csv', core\io\IMode::READ_ONLY));
    }
