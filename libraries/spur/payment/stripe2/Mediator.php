...
class Mediator implements IMediator
{
    ...
    {
        return new spur\payment\stripe2\filter\BalanceTransaction($type);
    }

    public function fetchBalanceTransactions(IBalanceTransactionFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'balance/history', spur\payment\stripe2\filter\BalanceTransaction::normalize($filter));
    ...
    {
        return new spur\payment\stripe2\request\ChargeCreate($amount, $description);
    }
    ...
    {
        return new spur\payment\stripe2\request\ChargeUpdate($id);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Charge($customerId);
    }

    public function fetchCharges(IChargeFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'charges', spur\payment\stripe2\filter\Charge::normalize($filter));
    ...
    {
        return new spur\payment\stripe2\request\ChargeCapture($chargeId, $amount);
    }
    ...
    {
        return new spur\payment\stripe2\request\CustomerCreate($emailAddress, $description);
    }
    ...
    {
        return new spur\payment\stripe2\request\CustomerUpdate($id);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Customer();
    }

    public function fetchCustomers(ICustomerFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'customers', spur\payment\stripe2\filter\Customer::normalize($filter));
    ...
    */
    ...
    {
        return new spur\payment\stripe2\request\RefundCreate($chargeId, $reason);
    }
    ...
    {
        return new spur\payment\stripe2\request\RefundUpdate($id);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Refund($chargeId);
    }

    public function fetchRefunds(IRefundFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'refunds', spur\payment\stripe2\filter\Refund::normalize($filter));
    ...
    */
    ...
    {
        return new spur\payment\stripe2\request\CardCreate($customerId, $source);
    }
    ...
    {
        return new spur\payment\stripe2\request\CardUpdate($customerId, $cardId);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Card();
    }

    public function fetchCards(string $customerId, ICardFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'customers/'.$customerId.'/sources', spur\payment\stripe2\filter\Card::normalize($filter, ['object' => 'card']));
    ...
    */
    ...
    {
        return new spur\payment\stripe2\request\PlanCreate($id, $name, $amount, $interval);
    }
    ...
    {
        return new spur\payment\stripe2\request\PlanUpdate($id);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Plan();
    }

    public function fetchPlans(IPlanFilter $filter=null): IDataList
    {
        $data = $this->requestJson('get', 'plans', spur\payment\stripe2\filter\Plan::normalize($filter));
    ...
    {
        return new spur\payment\stripe2\request\SubscriptionCreate($customerId, $planId);
    }
    ...
    {
        return new spur\payment\stripe2\request\SubscriptionUpdate($id);
    }
    ...
    {
        return new spur\payment\stripe2\filter\Subscription($customerId);
    }

    public function fetchSubscriptions(ISubscriptionFilter $filter=null)
    {
        $data = $this->requestJson('get', 'subscriptions', spur\payment\stripe2\filter\Subscription::normalize($filter));
