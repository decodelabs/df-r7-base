...
class Uuid implements IUuid, core\IDumpable {
    ...
    public static function v1($node=null, $time=null) {
        ...
        $uuid .= core\string\Generator::randomBytes(2);
        ...
        if(!$node) {
            $node = core\string\Generator::randomBytes(6);
    ...
    public static function v4() {
        $uuid = core\string\Generator::randomBytes(16);
        $uuid{8} = chr(ord($uuid{8}) & self::CLEAR_VARIANT | self::VARIANT_RFC);
    ...
    public static function comb() {
        $uuid = core\string\Generator::randomBytes(8);
        $time = self::_getMicrotime();
    ...
    public function __construct($bytes) {
        if(strlen($bytes) != 16) {
            throw new InvalidArgumentException(
                'Uuid must be a 128 bit integer'
            );
        }
